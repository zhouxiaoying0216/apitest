...
import static com.url.TestUrl.removeUser_url;
...
public class RemoveUserTest {
    ...
    /**
     * removeUser 接口的报文格式是 @RequestBody 所以：
     * 1. httpPost.setHeader 使用的 content-type 是 application/json
     * 2. httpPost.setEntity 使用的 entity 是 StringEntity
     */
    @Test
    public void removeUser_fail() throws IOException {

        // 1. 请求地址
        String url = removeUser_url;
        ...
        // 断言 - 另一种用法
        assertThat(response.contains("failed")).isEqualTo(true);
    }
}
